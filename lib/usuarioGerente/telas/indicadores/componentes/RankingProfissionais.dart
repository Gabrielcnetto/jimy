...
import 'package:friotrim/usuarioGerente/telas/adicionarProfissional/visaoTodosProfissionais.dart';
    ...
    return Padding(
      ...
      child: StreamBuilder<List<Barbeiros>>(
        ...
        builder: (
          ...
          } else if (listabarbeirosprimaria.length == 1) {
            return Container(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(40),
                                      child: Image.network(
                                        listabarbeirosprimaria[1].urlImageFoto,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(40),
                                      child: Image.network(
                                        listabarbeirosprimaria[0].urlImageFoto,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(40),
                                      child: Image.network(
                                        listabarbeirosprimaria[2].urlImageFoto,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
