...
class IconeHorarioDomingo extends StatefulWidget {
  final Horarios horario;
  
  const IconeHorarioDomingo({
    super.key,
  ...
  @override
  State<IconeHorarioDomingo> createState() => _IconeHorarioDomingoState();
}

class _IconeHorarioDomingoState extends State<IconeHorarioDomingo> {
  @override
  void initState() {
  ...
  Future<void> alterarOBool() async {
    ...
    try {
      await Provider.of<Ajustehorarios>(context, listen: false).setNewBoolDomingo(
