...
import 'package:fiotrim/usuarioGerente/telas/abrirApenasComanda/abrirApenasComanda.dart';
import 'package:fiotrim/usuarioGerente/telas/agendEaddScreen.dart/components/AgendarHorariosScreen.dart';
import 'package:fiotrim/usuarioGerente/telas/agendEaddScreen.dart/components/agendaCarregadaHorarios.dart';
import 'package:fiotrim/usuarioGerente/telas/agendEaddScreen.dart/editarAgendamento/botaoDeConfiguracaoAgenda.dart';
import 'package:fiotrim/usuarioGerente/telas/agendEaddScreen.dart/editarAgendamento/editarAgendamento.dart';
import 'package:fiotrim/usuarioGerente/telas/cadastrarDespesa/CadastrarDespesa.dart';
import 'package:provider/provider.dart';
import 'package:timeline_tile/timeline_tile.dart';

class AgendaEAddScreenFuncionarioView extends StatefulWidget {
  const AgendaEAddScreenFuncionarioView({super.key});

  @override
  State<AgendaEAddScreenFuncionarioView> createState() =>
      _AgendaEAddScreenFuncionarioViewState();
}

class _AgendaEAddScreenFuncionarioViewState
    extends State<AgendaEAddScreenFuncionarioView>
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: selectedIndex == index
                                            ? Dadosgeralapp()
                                                .primaryColor // Cor do item selecionado
                                            : Colors.grey
                                                .shade200, // Cor padrão dos outros itens
                                      ),
                                      child: Column(
                                        mainAxisAlignment:
