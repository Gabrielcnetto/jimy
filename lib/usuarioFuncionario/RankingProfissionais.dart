...
class RankingProfissionaisHomeFuncionario extends StatefulWidget {
  const RankingProfissionaisHomeFuncionario({
    super.key,
  });

  @override
  State<RankingProfissionaisHomeFuncionario> createState() =>
      _RankingProfissionaisHomeFuncionarioState();
}

class _RankingProfissionaisHomeFuncionarioState
    extends State<RankingProfissionaisHomeFuncionario> {
  @override
  void initState() {
